...
const AddNewProject = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await apiClient.post(endpoints.addNewProject, Details);
      ...
      <div className="bg-white w-full md:w-[90%] lg:w-[80%] m-auto p-4 lg:p-10 shadow rounded-lg">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-2 lg:gap-4">
            ...
            />
            <Select options={difficultyOptions } selectLabel="Difficulty Level" value={difficultyLevel} onChange={(e) => setDifficultyLevel(e.target.value)}/>
          </div>
          <Input
            name="Purpose"
            type="text"
