  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <ServiceCards url="/" title="Training" text="Our training services equip both individuals and industry teams with in-demand skills across Data Analytics, Power Platform, and App Development. " image="/assets/s1.png" linkText="Explore Training Programs" btnClass="bg-LightBlue w-[60%] text-white rounded-lg py-2 px-3 text-xs mx-auto" />
