    ...
    <div className="w-full flex flex-col-reverse md:flex-row gap-4 justify-between items-start text-center lg:text-left">
      <div className="flex-1">
        ...
        <Paragraph className="my-3 text-wrap text-black xxs:text-justify lg:text-left text-md">
          ...
          Your pathway to Data Mastery. Our wide range of services is
          designed to transform your learning experience, offering
          customized solutions for businesses and individuals. Unlock
          endless possibilities as we leverage data to fuel success,
